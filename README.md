...
Please use the data set provided. After importing it, study the drivers using statistical concepts (i.e., mean, correlation) and visualize the relationships among the continuous variables. Pick the drivers for the regression analysis, remove any that may bias the analysis, and assess the model quality. A recommendation on what characteristics customers spend the most should also be provided. There is a text file with the data set description for your convenience in the Jupyter workplace.    
